    		...
    		<div class="row-fluid" id="X_bodyContainer">
				...
				<form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/rolesResources/rolesResourcesUpdate.html">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="dateCreated" name="rolesResources.dateCreated" value="<fmt:formatDate value="${rolesResources.dateCreated}" pattern="yyyy-MM-dd"/>" class="Wdate" onclick="WdatePicker()" maxlength="19" placeholder="创建时间">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="lastUpdated" name="rolesResources.lastUpdated" value="<fmt:formatDate value="${rolesResources.lastUpdated}" pattern="yyyy-MM-dd"/>" class="Wdate" onclick="WdatePicker()" maxlength="19" placeholder="更新时间">
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
