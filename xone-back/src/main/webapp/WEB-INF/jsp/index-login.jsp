            ...
            <div class="hero-unit">
                <form class="form-horizontal" action="${pageContext.request.contextPath}/j_spring_security_check" method="post">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="username" id="text-username" value="admin" autocomplete="off" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="text-password">密 码</label>
                        <div class="controls">
                            <input type="password" name="password" id="text-password" value="admin" autocomplete="off" />
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
