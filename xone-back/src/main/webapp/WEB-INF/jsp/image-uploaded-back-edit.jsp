    		...
    		<div class="row-fluid" id="X_bodyContainer">
				...
				<form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/imageUploaded/imageUploadedUpdate.html">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="dateCreated" name="imageUploaded.dateCreated" value="<fmt:formatDate value="${imageUploaded.dateCreated}" pattern="yyyy-MM-dd HH:mm:ss"/>" class="Wdate" onclick="WdatePicker()" maxlength="19" placeholder="创建时间">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="lastUpdated" name="imageUploaded.lastUpdated" value="<fmt:formatDate value="${imageUploaded.lastUpdated}" pattern="yyyy-MM-dd HH:mm:ss"/>" class="Wdate" onclick="WdatePicker()" maxlength="19" placeholder="更新时间">
						</div>
					</div>
					<div class="control-group">
