    		...
    		<div class="row-fluid" id="X_bodyContainer">
				...
				<table class="table table-bordered" style="width:100%">
					<tbody>
						...
						<tr>
							<td style="width:60px;">父级ID</td>
							<td>${category.parentId}</td>
						</tr>
						<tr>
							<td style="width:60px;">删除标识</td>
							<td>${category.flagDeleted}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>${category.userUpdated}</td>
						</tr>
						<tr>
							<td style="width:60px;">更新日期</td>
							<td><fmt:formatDate value="${category.lastUpdated}" pattern="yyyy-MM-dd"/></td>
						</tr>
					</tbody>
				</table>
				</div>
