				...
				<table class="table table-bordered" style="width:100%">
					<tbody>
						...
						<tr>
							...
							<td><fmt:formatDate value="${imageUploaded.dateCreated}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><fmt:formatDate value="${imageUploaded.lastUpdated}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						</tr>
						<tr>
