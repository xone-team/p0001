				...
				<table class="table table-bordered" style="width:100%">
					<tbody>
						...
						<tr>
							...
							<td>${config.flagDeleted}</td>
						</tr>
						<tr>
							<td style="width:60px;">创建人</td>
							<td>${config.userCreated}</td>
						</tr>
						<tr>
							<td style="width:60px;">创建日期</td>
							<td><fmt:formatDate value="${config.dateCreated}" pattern="yyyy-MM-dd"/></td>
						</tr>
						<tr>
							<td style="width:60px;">更新人</td>
							<td>${config.userUpdated}</td>
						</tr>
						<tr>
							<td style="width:60px;">更新日期</td>
							<td><fmt:formatDate value="${config.lastUpdated}" pattern="yyyy-MM-dd"/></td>
						</tr>
					</tbody>
				</table>
				</div>
