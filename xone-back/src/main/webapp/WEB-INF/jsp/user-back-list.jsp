...
<body>
         ...
         <div class="row-fluid">
          ...
          <div class="span5 form-horizontal">
           <div class="control-group">
            ...
            <div class="controls">
             <div id="userApply" class="inline"></div>
             <button type="button" class="btn inline" onclick="showModalPersonSelect($('#userApply'));">
         ...
         <div class="row-fluid">
          ...
          <div class="span5 form-horizontal">
           <div class="control-group">
            ...
            <div class="controls">
             <input type="text" id="flagDeleted" name="person.flagDeleted" value="${person.flagDeleted}" maxlength="1" placeholder="删除标识">
            </div>
           </div>
          </div>
         </div>
      ...
      <tbody>
       <c:forEach var="item" items="${pagination.list}" varStatus="status">
        <tr>
         ...
         <td><a href="${pageContext.request.contextPath}/person/personEdit.html?person.id=${item.id}" class="btn btn-mini"><i class="icon-edit"> </i>编辑</a> <button class="btn btn-mini" onclick="showModalDelete('person.id=${item.id}')"><i class="icon-trash"> </i>删除</button></td>
        </tr>
       </c:forEach>
      </tbody>
     </table>
 ...
 <div id="X_model_personSelect" class="modal hide fade" aria-hidden="true">
  ...
  <div class="modal-body">
   ...
   <div class="row-fluid">
    <p class="text-right">
     <button class="btn btn-small" onclick="queryModal();">
  ...
  <div class="modal-footer">
   ...
   <button class="btn btn-primary" onclick="endModalPersonSelect();">完成</button>
  </div>
 </div>
 <script type="text/javascript">
        function showModalPersonSelect(targetObj) {
            XONE.CURRENT_MODEL = {};
            XONE.CURRENT_MODEL.target = targetObj;
            XONE.CURRENT_MODEL.modal = jQuery("#X_model_personSelect");
            XONE.CURRENT_MODEL.listBody = jQuery("#tbodyList");
            XONE.CURRENT_MODEL.container = jQuery("#queryForm");
            XONE.CURRENT_MODEL.queryUrl = "${pageContext.request.contextPath}/person/personSelect.html";
            XONE.CURRENT_MODEL.modal.modal("show");
        }
        function endModalPersonSelect() {
            ...
            if (selectedResult == null) {
                ...
                targetObj.html(selectedResult.clone().removeClass("hide").addClass("inline"));
            }
        }
