				...
				<table class="table table-bordered" style="width:100%">
					<tbody>
						...
						<tr>
							...
							<td><fmt:formatDate value="${rolesResources.dateCreated}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><fmt:formatDate value="${rolesResources.lastUpdated}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						</tr>
					</tbody>
				</table>
				</div>
