				...
				<div class="span10">
					...
					<form class="form-horizontal" enctype="multipart/form-data" id="adbannerSaveForm${myidentify}" method="post" action="${pageContext.request.contextPath}/adbanner/adbannerSave.html">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="refId" name="adbanner.refId" maxlength="20" placeholder="广告对象编号" readonly="readonly"><code>*</code>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="userId" name="adbanner.userId" maxlength="20" placeholder="用户编号" readonly="readonly"><code>*</code>
						...
						<div class="control-group">
							...
							<div class="controls">
								<div class="input-append date datepicker adbanneradstart" data-date-format="yyyy-mm-dd">
									<input type="text" id="adStart" name="adbanner.adStart" maxlength="19" placeholder="开始时间" readonly><code>*</code>
						...
						<div class="control-group">
							...
							<div class="controls">
								<div class="input-append date datepicker adbanneradend" data-date-format="yyyy-mm-dd">
									<input type="text" id="adEnd" name="adbanner.adEnd" maxlength="19" placeholder="结束时间" readonly><code>*</code>
									<span class="add-on"><i class="icon-th"></i></span>
								</div>
							</div>
						</div>
