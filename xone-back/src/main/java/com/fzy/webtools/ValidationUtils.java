...
import com.fzy.core.entity.ValidationRuleGroup;
import com.fzy.core.entity.ValidatorConfig;
...
//                    log.info(validatorName);
    ...
    public static boolean validate(RestForm form, ValidationContext context, JSONObject rulesConfig, JSONObject validatorsConfig) throws Exception {
        ...
        for (Iterator iterator = rules.iterator(); iterator.hasNext();) {
            ...
            if(item instanceof ValidationRule){
                ValidationRule rule = (ValidationRule) item;
            ...
            if(item instanceof ValidationRuleGroup){
                ValidationRuleGroup group = (ValidationRuleGroup) item;
                ...
                for (Iterator iterator2 = subRules.iterator(); iterator2.hasNext();) {
                    ValidationRule subRule = (ValidationRule) iterator2.next();
