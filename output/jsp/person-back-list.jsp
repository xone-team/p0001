									...
									<div class="row-fluid">
										<div class="span5 form-horizontal">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="dateApplyMin" class="span5 Wdate" onclick="WdatePicker()" name="person.dateApplyMin"  value="${person.dateApplyMin}"  maxlength="19" placeholder="申请日期">
													<span class="add-on">~</span>
													<input type="text" id="dateApplyMax" class="span5 Wdate" onclick="WdatePicker()" name="person.dateApplyMax"  value="${person.dateApplyMax}"  maxlength="19" placeholder="申请日期">
												</div>
											</div>
										</div>
										<div class="span5 form-horizontal">
									...
									<div class="row-fluid">
										<div class="span5 form-horizontal">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="dateCheckMin" class="span5 Wdate" onclick="WdatePicker()" name="person.dateCheckMin"  value="${person.dateCheckMin}"  maxlength="19" placeholder="审核日期">
													<span class="add-on">~</span>
													<input type="text" id="dateCheckMax" class="span5 Wdate" onclick="WdatePicker()" name="person.dateCheckMax"  value="${person.dateCheckMax}"  maxlength="19" placeholder="审核日期">
												</div>
											</div>
										</div>
										<div class="span5 form-horizontal">
									...
									<div class="row-fluid">
										...
										<div class="span5 form-horizontal">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="dateCreatedMin" class="span5 Wdate" onclick="WdatePicker()" name="person.dateCreatedMin"  value="${person.dateCreatedMin}"  maxlength="19" placeholder="创建日期">
													<span class="add-on">~</span>
													<input type="text" id="dateCreatedMax" class="span5 Wdate" onclick="WdatePicker()" name="person.dateCreatedMax"  value="${person.dateCreatedMax}"  maxlength="19" placeholder="创建日期">
												</div>
											</div>
										</div>
									</div>
									<div class="row-fluid">
										...
										<div class="span5 form-horizontal">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="lastUpdatedMin" class="span5 Wdate" onclick="WdatePicker()" name="person.lastUpdatedMin"  value="${person.lastUpdatedMin}"  maxlength="19" placeholder="更新日期">
													<span class="add-on">~</span>
													<input type="text" id="lastUpdatedMax" class="span5 Wdate" onclick="WdatePicker()" name="person.lastUpdatedMax"  value="${person.lastUpdatedMax}"  maxlength="19" placeholder="更新日期">
												</div>
											</div>
										</div>
									</div>
