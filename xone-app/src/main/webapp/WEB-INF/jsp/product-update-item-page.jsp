				    ...
				    <li>
				    	<table style="width:100%">
				    		<tr>
				    			...
				    			<td><input type="text" id="productupdateproductvalid" name="product.productValid" placeholder="有效期" data-mini="true" value="${product.productValid}" autocomplete="off"/></td>
				    		</tr>
				    	</table>
				    </li>
				    <li>
