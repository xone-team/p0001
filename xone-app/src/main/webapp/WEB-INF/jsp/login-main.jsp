...
<!-- 				    <li><a href="#" onclick="window.main.loadGuideIndex();" rel="external" data-icon="home">软件首页</a></li> -->
		    ...
		    <div data-role="collapsible" data-collapsed="false" data-content-theme="d">
				...
				<ul data-role="listview" data-inset="true" data-divider-theme="d">
				    <li class="ui-li-has-icon"><img src="${STATIC_ROOT}/image/product_24.png" class="ui-li-icon ui-li-thumb"><a href="${pageContext.request.contextPath}/product/listAllForUser.html?product.saleType=0&_=${myid}">查看产品发布列表</a></li>
				    <li class="ui-li-has-icon"><img src="${STATIC_ROOT}/image/sale_24.png" class="ui-li-icon ui-li-thumb"><a href="${pageContext.request.contextPath}/product/listAllForUser.html?product.saleType=1&_=${myid}">查看促销发布列表</a></li>
				    <c:if test="${A_L}">
