...
public class CategoryServiceImpl implements CategoryService {
	...
	protected void handleCriteriaByParams(DetachedCriteria criteria, Map<String, String> params){
		...
		String parentIdMin = params.get("parentIdMin");
        if (!StringUtils.isBlank(parentIdMin)) {
            criteria.add(Restrictions.ge("parentId", new Long(parentIdMin)));
        }
		String parentIdMax = params.get("parentIdMax");
        if (!StringUtils.isBlank(parentIdMax)) {
            criteria.add(Restrictions.le("parentId", new Long(parentIdMax)));
        }
