                        ...
                        <c:forEach var="item" items="${pagination.list}" varStatus="status">
                            <tr>
                                ...
                                <td><c:if test="${item.checkStatus != '1'}">
                                        <a href="${pageContext.request.contextPath}/productGroup/productGroupEdit.html?productGroup.id=${item.id}" class="btn btn-mini">
                                            <i class="icon-edit"> </i>编辑
                                        </a>
                                    </c:if> <a href="${pageContext.request.contextPath}/productGroup/productGroupItem.html?productGroup.id=${item.id}" class="btn btn-mini">
