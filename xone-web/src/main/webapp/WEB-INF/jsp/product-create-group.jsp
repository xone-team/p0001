...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="span3">
                <jsp:include page="user-center-menu.jsp"><jsp:param value="8" name="menuindex" />
                </jsp:include>
            </div>
            <div class="span9">
                <ul class="breadcrumb">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" id="productSaveForm${myidentify}" method="post" action="${pageContext.request.contextPath}/product/productSave.html">
                    ...
                    <input type="hidden" name="product.saleType" value="2">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select class="selectpicker" id="saleType" name="product.saleType" disabled="disabled">
                                <c:forEach items="${saleType}" var="it">
                                    <option value="${it.value}" <c:if test="${it.value == '2'}">selected</c:if>>${it.name}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
