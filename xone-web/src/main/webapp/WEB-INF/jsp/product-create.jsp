...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="span3">
                <c:choose>
                    <c:when test="${product.saleType == '1' }"><jsp:include page="user-center-menu.jsp"><jsp:param value="7" name="menuindex" />
                        </jsp:include></c:when>
                    <c:when test="${product.saleType == '2' }"><jsp:include page="user-center-menu.jsp"><jsp:param value="8" name="menuindex" />
                        </jsp:include></c:when>
                    <c:otherwise><jsp:include page="user-center-menu.jsp"><jsp:param value="6" name="menuindex" />
