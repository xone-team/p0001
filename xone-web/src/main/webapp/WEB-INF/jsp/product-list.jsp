...
<body>
    <jsp:include page="common-nav.jsp"><jsp:param value="${ product.saleType == '1' ? 4 : (product.saleType == '2' ? 6 : 2) }" name="offset" /></jsp:include>

    <!--主体-->
    <div id="container">

        <!--位置导航-->
        <div class="wzdh">首页&nbsp;&gt;&nbsp;大家在卖</div>
        <!--位置导航 end-->
        ...
        <div class="fl" style="width: 230px;">
            <div class="list_left">
                ...
                $.ajax({
                    type : 'get',
                    url : '${pageContext.request.contextPath}/product/listHot.html?product.saleType=${product.saleType}&_=' + new Date().getTime(),
                    ...
                    <c:forEach var="item" items="${pagination.list}">
                        <li>
                            ...
                            <dl>
                                ...
                                <p>产品地址:${item.productAddress},产品属地:${item.productLocation},产品类型:${item.productTypeName},产品描述:${item.productDesc}</p>
