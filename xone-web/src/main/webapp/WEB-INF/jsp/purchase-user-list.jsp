		...
		<div class="row">
			...
			<div class="span9">
				<ul class="breadcrumb">
					...
					<li class="active">purchase列表</li>
					<li class="pull-right"><a href="${pageContext.request.contextPath}/purchase/purchaseCreate.html" class="btn btn-mini">创建purchase</a></li>
				</ul>
				<table class="table table-bordered" style="width:100%">
					...
					<tr>
						...
						<td>
							<a href="${pageContext.request.contextPath}/purchase/purchaseEdit.html?roles.id=${item.id}" class="btn btn-mini">编辑</a>
							<a href="${pageContext.request.contextPath}/purchase/purchaseItem.html?roles.id=${item.id}" class="btn btn-mini">详细</a>
						</td>
					</tr>
					</c:forEach>
					</tbody>
